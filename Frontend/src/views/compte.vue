    ...
    <div class="compte-contenair">
      ...
      <div class="compte-contains-infos">
        <form class="form-buttons">
          <input @click="change_lastname" class="form-buttons-btns" type="submit" value="Modifier mon Nom" />
          <br />
          <input @click="change_firstname" class="form-buttons-btns" type="submit" value="Modifier mon Prénom" />
          <br />
          <input @click="change_email" class="form-buttons-btns" type="submit" value="Modifier mon Email" />
          <br />
        ...
        <form class="form-inputs">
          ...
          <input id="Firstname" class="form-buttons-inputs" type="textarea" placeholder="PRÉNOM" name="prénom" />
