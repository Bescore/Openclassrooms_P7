    ...
    <div>
      <div class="posts" :key="index" v-for="(posted, index) in posted">
        ...
        <div tabindex="0" id="post-body" class="posts-comments-2">
          <div class="posts-comments-child-2" :key="comindex" v-for="(commentaires, comindex) in commentaires">
            <div class="round-name">
              <input v-if="this.accountOwner.isAdmin == 1" @click="delComment(commentaires.idcommentaire)" value="x" type="button" />
        ...
        <form class="form">
          ...
          <div tabindex="0" class="created-by">
            ...
            <img class="post-roundpic" :src="posted.photo" alt="créateur du post" />
          </div>
        </form>
      </div>
    </div>
        ...
        axios
          ...
          .then((response) => {
            ...
            if (response.data == "nope") {
              alert(" vous ne pouvez pas supprimer un post que vous n'avez pas créé !");
            }
          }),
          (error) => {
            console.log(error);
