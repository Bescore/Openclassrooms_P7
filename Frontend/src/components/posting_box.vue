<template>
  <form class="create-posts-contains">
    <div class="create-posts-contains-inputs">
      ...
      <textarea v-model="titre" id="post_title" class="create-posts-contains-inputs-title" placeholder="Ajouter un titre à votre post"></textarea><br />
      <label tabindex="0" for="post_body">Partagez vos impressions !</label><br />
      <textarea v-model="post_body" id="post_body" class="create-posts-contains-inputs-commentaires" placeholder="Réagissez ici!"></textarea><br />
      ...
      <input @click="addpost" class="create-posts-contains-inputs-btn" type="submit" value="Créer Post !" name="addpost" />
    </div>
  </form>
</template>
